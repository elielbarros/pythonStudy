...
connection = pymysql.connect(
    ...
    cursorclass=CURRENT_CURSOR  # To use unbuffered cursor it is necessary use SSDictCursor
)
...
with connection:
    ...
    with connection.cursor() as cursor:
        ...
        # When you have many data, infinite data, it is better use an Unbuffered Cursor
        # SSCursor
        # It is not possible to scroll back with SSCursor because only actual row is saved on memory
        print('for with fetchall_unbuffered()')
