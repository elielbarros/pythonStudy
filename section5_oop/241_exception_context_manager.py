...
class MyOpen:
    ...
    def __exit__(self, class_exception, exception_, traceback_):
        ...
        # It is possible to raise exception
        # raise class_exception

        # It is possible to raise class exception with exception args
        # raise class_exception(*exception_.args)

        # It is possible to raise class exception with exception args and traceback
        # raise class_exception(*exception_.args).with_traceback(traceback_)

        # It is also possible to raise another exception
        # raise ConnectionError('It was not possible to connect')

        # It is also possible to return True indicating that exception was treated already
        return True
...
with MyOpen('240_class.txt', 'w') as file:
    ...
    # <traceback object at 0x7f2284f7cd00>
    file.write('Line 3\n')
    print('WITH', file)
