...
print(new_product_mapped)
print(hasattr(new_product_mapped, '__iter__'))
print(hasattr(new_product_mapped, '__next__'))
...
print(new_product_generator)
print(hasattr(new_product_generator, '__iter__'))
print(hasattr(new_product_generator, '__next__'))
print(isinstance(new_product_generator, GeneratorType))
