...
def main() -> None:
    ...
    print(sum_(3, 4))  # output: 7


# This code will work only when the script module.py is being executed as principal program
# This code will not work if it is being imported by another script
